...
*/
  ...
  */
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class continuous_ContinuousViewManager
          extends managers_default["a" /* default */]
        {
          constructor(options) {
            super(options);
          ...
          scheduleTrim(delay = 250) {
            ...
            this.trimTimeout = setTimeout(
              function () {
                ...
                if (
                  (this.scrollDeltaVert || 0) > 2 ||
                  (this.scrollDeltaHorz || 0) > 2
                ) {
          ...
          scrolled() {
            let scrolledTask = this.q.enqueue(
              function () {
                return this.check();
              }.bind(this),
            );
